...
<meta charset="UTF-8">
<link rel="pingback" href="http://dellaquilainvestment.com">
...
<link rel="alternate" type="application/rss+xml" title="Dell'Aquila Investments » Feed" href="http://dellaquilainvestment.com">
<link rel="alternate" type="application/rss+xml" title="Dell'Aquila Investments » Comments Feed" href="http://dellaquilainvestment.com">	
                    ...
                    <form class="modal-content animate" name= "frmLoginCheck" action="LoginCheck" method ="post">
                        <div class="imgcontainer">
                            ...
                            <div class="container">
                                 ...
                                 <span class="psw"><input type="checkbox" checked="checked"> Remember me  <br></span>
                           </div> 
	    ...
	    <div class="camera_wrap camera_emboss" id="camera_wrap">
		   ...
		   <center><h1>For further Information Contact us: </h1><h3>info@dellaquilainvestments.com</h3><br></center>						
			    ...
			    <footer id="footer-main">	
					<div id="copyright">
						  Â© 2017  Dell'Aquila Investments.  All Rights Reserved. 					
					</div><!-- #copyright -->			
			    </footer><!-- #footer-main -->  
